...
<div class="container adminHome">
	<div class=row>
		<div class="col-md-6 col-offset-md-6">
			<h3 class="border-bottom-green">Редагувати Звязки між містами</h3>

			<form:form
				action="${pageContext.request.contextPath}/updateRC/${id}"
				method="POST" role="form" commandName="dto">
				<c:if test="${not empty dangerResultEdit}">
						<div class="alert alert-danger">${dangerResultEdit}</div>
					</c:if>
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="from-to">Звідки</div>
						<div class="form-group">
							<select name="countryA" class="form-control" id="fromCountryEditRC">
						...
						<div class="form-group">
							...
							<select name="routePointA" class="form-control"
									id="fromCityEditRC">									
					...
					<div class="col-md-6 col-sm-6">
						...
						<form:select path="routePointB" class="form-control" id="toCityEditRC">
				...
				<div class="form-group">
					...
					<select name="transport" class="form-control">
							<c:forEach items="${transportList}" var="transport">
								<option value="${transport.id}" <c:if test="${transportId==transport.id}">selected </c:if>>${transport.name}</option>
							</c:forEach>
						</select>
				</div>
				<div class="form-group">
					...
					<div class="text-right">
						<button type="submit" class="btn btn-success btn-sm">
							<i class="glyphicon glyphicon-ok"></i> Редагувати
						</button>
